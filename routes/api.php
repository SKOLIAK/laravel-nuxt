...
use App\Http\Controllers\BacktesterController;
...
Route::prefix('api/v2')->group(function () {
    ...
    Route::middleware(['auth:sanctum'])->group(function () {
        ...
        Route::post('backtesting/folders', [BacktesterController::class, 'updateFolder']);
        Route::put('backtesting/folders', [BacktesterController::class, 'createFolder']);

        /** CRUD: INDIVIDUAL BACKTESTS */
        Route::get('backtesting/backtests', [BacktesterController::class, 'getBacktests']);
        Route::delete('backtesting/backtests', [BacktesterController::class, 'deleteBacktest']);
        Route::post('backtesting/backtests', [BacktesterController::class, 'updateBacktest']);
        Route::put('backtesting/backtests', [BacktesterController::class, 'createBacktest']);
