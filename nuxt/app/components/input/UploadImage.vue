...
<template>
  <div class="flex gap-6">
    <div class="relative flex">
      ...
      <UTooltip text="Upload" class="absolute end-0 top-0 -m-2" :popper="{ placement: 'right' }">
        <UButton
          type="button"
          color="gray"
      ...
      <UTooltip text="Delete" class="absolute bottom-0 end-0 -m-2" :popper="{ placement: 'right' }">
        <UButton
          type="button"
          color="gray"
