...
<template>
  <header
    class="bg-background/75 sticky top-0 z-50 -mb-px border-b border-dashed border-gray-200/80 backdrop-blur dark:border-gray-800/80"
  >
    <UContainer class="flex h-16 items-center justify-between gap-3 py-2">
  ...
  <USlideover v-model="isSideOpen" :ui="{ width: 'max-w-xs' }" @close="">
    <UContainer
      class="flex h-16 items-center justify-between gap-3 border-b border-dashed border-gray-200/80 py-2 dark:border-gray-800/80"
    >
      <AppLogo />
      <UButton
        variant="ghost"
